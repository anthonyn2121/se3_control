"""
Code taken from my old Upenn MEAM 620 class! 
Which, I believe, now acts as a basis to a UPenn PhD student Spencer Folk's paper entitled
"RotorPy: A Python-based Multirotor Simulator with Aerodynamics for Education and Research"
Github here:
https://github.com/spencerfolk/rotorpy/blob/main/rotorpy/utils/shapes.py
